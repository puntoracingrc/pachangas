...
export const CANONICAL_CONTRACTS: CanonicalContract[] = [
  ...
  { area: "teams", classification: "implemented", execution: "product_rpc", flow: "team.admin_invite_accept", route: "accept_pachanga_admin_invite_authoritative_v1", timeInjectable: false },
  ...
  { area: "teams", classification: "implemented", execution: "product_rpc", flow: "team.member_remove", route: "remove_pachanga_group_member_authoritative_v1", timeInjectable: false },
  { area: "teams", classification: "implemented", execution: "product_rpc", flow: "team.owner_transfer", route: "transfer_pachanga_group_ownership_authoritative_v1", timeInjectable: false },
  ...
  { area: "market", classification: "implemented", execution: "product_rpc", flow: "market.open_match_request", route: "request_pachanga_open_match_authoritative_v2", timeInjectable: false },
  { area: "market", classification: "implemented", execution: "product_rpc", flow: "market.open_match_review", route: "review_pachanga_open_match_request_authoritative_v2", timeInjectable: false },
  { area: "market", classification: "implemented", execution: "product_rpc", flow: "market.guest_leave", route: "leave_pachanga_guest_match_v1", timeInjectable: false },
  ...
  { area: "cosmetics", classification: "implemented", execution: "product_trigger", flow: "cosmetic.inventory_grant", route: "private.pachanga_player_cosmetic_inventory_after_insert_v1", timeInjectable: false },
  { area: "cosmetics", classification: "implemented", execution: "product_rpc", flow: "cosmetic.mark_seen", route: "mark_pachanga_player_cosmetics_seen_v1", timeInjectable: false },
  { area: "cosmetics", classification: "implemented", execution: "product_rpc", flow: "cosmetic.save_loadout", route: "save_pachanga_player_cosmetic_loadout_v1", timeInjectable: false },
  { area: "cosmetics", classification: "implemented", execution: "product_rpc", flow: "cosmetic.equip_from_box", route: "equip_pachanga_player_cosmetic_from_box_v1", timeInjectable: false },
