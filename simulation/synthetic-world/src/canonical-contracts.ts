...
export const CANONICAL_CONTRACTS: CanonicalContract[] = [
  ...
  { area: "attendance", classification: "not_implemented", execution: "unavailable", flow: "attendance.no_show", route: null, timeInjectable: false },
  ...
  { area: "conduct", classification: "not_implemented", execution: "unavailable", flow: "conduct.player_report", route: null, timeInjectable: false },
  { area: "conduct", classification: "not_implemented", execution: "unavailable", flow: "conduct.social_sanction", route: null, timeInjectable: false },
