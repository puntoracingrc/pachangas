...
export function PublicClubProfile({ club, embedded = false }: { club: JsonRecord | null; embedded?: boolean }) {
  ...
  const content = <main className={styles.page} data-mobile-tab="mercado">
    <GamePageHeader actions={embedded ? undefined : <><Link href="/clubes">Directorio</Link><Link href="/clubes/gestionar">Gestionar Clubs</Link></>} eyebrow="Club público · BETA" summary="Información publicada por el Club y confirmada por el servidor central." title={name} />
