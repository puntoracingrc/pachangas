...
export function OrganizerAccessClient({ initialApplicationId = "", initialPlanCode = "", surface }: { initialApplicationId?: string; initialPlanCode?: string; surface: Surface }) {
  ...
  return <OfficialProductShellV2 active="competir" perspective="team-owner" context={{ detail: "Solicitud, revisión y primera competición", eyebrow: "Organización", status: shellStatus, title: "Organizar" }}>
