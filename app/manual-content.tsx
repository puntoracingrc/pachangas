const manualFlows = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Después puedes hacer una sola vez el test avanzado opcional desde Mi perfil > Mejorar precisión de mi carta. Sus preguntas se adaptan al resultado inicial.",
      "Pulsa Mi perfil para editar tus datos personales permitidos: nombre, teléfono Bizum, foto, posición preferida y estado. El test y las valoraciones no se sustituyen escribiendo una media a mano.",
