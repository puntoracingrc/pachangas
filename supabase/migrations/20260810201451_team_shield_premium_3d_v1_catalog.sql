-- Premium Team Shield RC catalog. Catalog-only and forward-only:
-- no feature activation, reward mapping, grants, or sporting data changes.
...
insert into public.pachanga_cosmetic_catalog(
  ...
  (
    'team.shield.symbol.ball_premium', 2, 'symbol', 'Balón Premium',
    'Balón multivista con profundidad opcional por sensor.', 'legendary', 'achievement',
    '{"symbol":"ball_premium","premiumPipeline":"multiview-8-v1"}',
    40, true, 'team', 'primary_symbol', 'noche_de_partido', 'pearl', 'active_reward'
  ),
  (
...
-- Deliberately absent: reward-pool mappings and inventory grants. Staging QA
-- grants the premium ball through the existing service-role-only controlled RPC.
